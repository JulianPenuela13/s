...
let RedemptionsController = class RedemptionsController {
    ...
    create(createRedemptionDto, req) {
        const { empresaId } = req.user;
        return this.redemptionsService.create(createRedemptionDto, empresaId);
    }
    findAll(req) {
        const { empresaId } = req.user;
        return this.redemptionsService.findAll(empresaId);
    }
    findOne(id, req) {
        const { empresaId } = req.user;
        return this.redemptionsService.findOne(id, empresaId);
    }
};
...
__decorate([
    ...
    __metadata("design:returntype", void 0)
], RedemptionsController.prototype, "findOne", null);
